...
# partidas.index = partidas.index.map(normalizar_indice)  asi deberia usarse la funcion de normalizar el indice

# partidas = partidas.astype(float)  asi deberia usarse la funcion de normalizar el indice
...
# Asi deberia usarse la funcion de ultimo año estable:
# anio_corte, fcff_hasta_corte = elegir_ultimo_fcff_estable(
#     partidas,                      # tu DataFrame
#     fila_fcff="FCFF",
#     k_pos=4,                 # exijo 3 años seguidos positivos
# )
